package com.uibenglish.aslan.mvpmindorkssample.playbutton;
...
public class PlayPauseView extends FrameLayout {
    ...
    public PlayPauseView(Context context, AttributeSet attrs) {
        ...
        mPauseBackgroundColor = getResources().getColor(R.color.colorAccent);
        mPlayBackgroundColor = getResources().getColor(R.color.colorPrimary);
        toggle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("AAA", "PlayPauseView: "+pixels+"   "+size);*/
